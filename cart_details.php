	...
	if(isset($_SESSION['user'])){
		...
		try{
			...
			foreach($stmt as $row){
				...
				$output .= "
					<tr>
						<td><button type='button' data-id='".$row['cartid']."' class='btn btn-danger btn-flat cart_delete'><i class='fa fa-trash-can'></i></button></td>
						<td><img src='".$image."' width='30px' height='30px'><sup><b>".$row['quantity']."</b></sup></td>
						<td>".$row['name']."</td>
